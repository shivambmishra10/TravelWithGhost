            ...
            <Card className="trip-card animate-slide-in">
              ...
              <Card.Body className="p-4">
                <div className="trip-stats">
                  ...
                  {trip.budget && (
                    <div className="stat-item">
                      <div className="stat-value">₹{parseFloat(trip.budget).toFixed(2)}</div>
                      <div className="stat-label">Budget/Person</div>
                    </div>
                  )}
                </div>
          ...
          <Col lg={4}>
            <Card className="trip-card mb-4">
              <Card.Body className="p-4">
                ...
                {trip.budget && (
                  <div className="mb-4">
                    <strong>Budget Per Person:</strong> ₹{parseFloat(trip.budget).toFixed(2)}
                  </div>
                )}
              </Card.Body>
            </Card>
